...
const RunningIcon = ({ color }: IconComponentProps) => {
  const theme = useTheme();
  return (
    <svg xmlns='http://www.w3.org/2000/svg' height='200px' width='200px' viewBox='0 0 50 50' fill={color ?? theme.icons.RUNNING}>
