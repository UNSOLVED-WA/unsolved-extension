...
const DefaultIcon = ({ color, width, height }: IconComponentProps) => {
  const theme = useTheme();
  return (
    <svg xmlns='http://www.w3.org/2000/svg' height={height ?? '48'} width={width ?? '48'} fill={color ?? theme.icons.DEFAULT}>
