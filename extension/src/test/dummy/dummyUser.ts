...
export const dummyUser: SolvedUser = {
  ...
  user: {
    background: {
      author: 'Photo by Jason Leung on Unsplash',
      authorUrl: 'https://unsplash.com/photos/Gq1afT1gGt4',
      backgroundId: 'balloon_005',
      backgroundImageUrl: 'https://static.solved.ac/profile_bg/balloon_005/balloon_005.png',
      displayDescription: 'assorted-color LED balloons',
      displayName: '빨간색, 노란색, 파란색 풍선',
    ...
    rating: 888,
    ratingByClass: 0,
    ratingByProblemsSum: 819,
    ratingBySolvedCount: 69,
    ratingByVoteCount: 0,
    reverseRivalCount: 0,
    rivalCount: 0,
    settings: {},
